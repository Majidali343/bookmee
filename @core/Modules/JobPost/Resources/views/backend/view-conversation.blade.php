                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="dashboard-settings margin-top-40">
                                <h2 class="dashboards-title"> {{__('Job Request Conversation Details')}} </h2>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="gig-chat-message-heading">
                                        <div class="header-wrap d-flex justify-content-between">
                                            <h4 class="header-title">{{__('Job Request Conversation Details')}}</h4>
                                            <a class="btn btn-primary btn-xs" href="{{route('admin.jobs.all')}}">{{__('All Jobs')}}</a>
                                        </div>

                                        <div class="gig-order-info">
                                            <p><strong>{{__('Request ID:') }}</strong> #{{ $request_details->id }}</p>
                                            <p><strong>{{__('Job ID:') }}</strong> #{{ $request_details->job_post_id }}</p>
                                            <p><strong>{{__('Job Title:') }}</strong> #{{ optional($request_details->job)->title }}</p>
                                            <p><strong>{{__('Seller Budget:') }}</strong> {{ float_amount_with_currency_symbol($request_details->expected_salary) }}</p>
                                        </div>
