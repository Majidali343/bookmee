...
@section('content')
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            <div class="col-lg-6">
                <div class="dashboard-settings margin-top-40">
                    <h3 class="dashboards-title"> {{__('Edit Service Attributes')}} </h3>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.edit.service.attribute.offline.and.online',$get_service->id)}}" method="post">
                    @csrf

                    <input type="hidden" name="service_id" value="{{$get_service->id}} ">
                    @if($get_service->is_service_online == 0)
                        ...
                        <div class="col-xl-8 margin-top-50">
                            @if($get_service->is_service_online == 1)
                                <div class="dashboard-switch-single margin-bottom-30">
                                    <input class="custom-switch is_service_online" id="is_service_online" type="checkbox" checked disabled/> {{__('Online To Offline Service')}}
                                    <label class="switch-label" for="is_service_online"></label>
                                </div>
                            @else
                                <div class="dashboard-switch-single margin-bottom-30">
                                    <input class="custom-switch is_service_online" id="is_service_online" type="checkbox" checked/> {{__('Offline To Online Service')}}
                                    <label class="switch-label" for="is_service_online"></label>
                                </div>
                            @endif
                            <div class="single-settings">
                                ...
                                <div class="append-additional-includes">
                                    <div class="single-dashboard-input what-include-element">
                                        ...
                                        @if($get_service->is_service_online == 1)
                                        <div class="single-info-input margin-top-20 @if($get_service->is_service_online == 0) is_service_online_hide @endif">
