                                    ...
                                    <div class="profile-info-dashboard margin-top-40">
                                        <div class="profile-btn-flex">
                                            ...
                                            <div class="btn-wrapper">
                                                <a href="{{ route('seller.profile.edit') }}" class="cmn-btn btn-bg-1">
                                                    {{ __('Edit Profile') }} </a>
                                            </div>
                                        </div>
                                        <div class="dashboard-profile-detail margin-top-40">
                                            <div class="dashboard-profile-flex">
                                                <div class="thumbs">
                                                    ...
                                                    @else
                                                        <img src="{{ asset('assets/frontend/img/static/user_profile.png') }}"
                                                            alt="No Image">
                                                    @endif
                                                </div>
                                                <div class="dashboard-address-details">
                                                    <ul class="details-list">
                                                        ...
                                                        <li class="lists">
                                                            ...
                                                            <span class="list-strong">
                                                                {{ Auth::guard('web')->user()->phone }} </span>
                                                        </li>
                                                        <li class="lists">
                                                            <span class="list-span"> {{ __('City:') }} </span>
                                                            <span class="list-strong">
                                                                {{ optional(optional(Auth::guard('web')->user())->city)->service_city }}
                                                            </span>
                                                        </li>
                                                        {{-- <li class="lists">
                                                            <span class="list-span"> {{ __('Area:') }} </span>
                                                            <span class="list-strong">
                                                                {{ optional(optional(Auth::guard('web')->user())->area)->service_area }}
                                                            </span>
                                                        </li> --}}
                                                        <li class="lists">
                                                        ...
                                                        <li class="lists">
                                                            ...
                                                            <span class="list-strong">
                                                                {{ Auth::guard('web')->user()->post_code }} </span>
                                                        </li>
                                                        <li class="lists">
                                                            <span class="list-span"> {{ __('Address:') }} </span>
                                                            <span class="list-strong">
                                                                {{ Auth::guard('web')->user()->address }} </span>
                                                        </li>
                                                    </ul>
                                                    @if (Auth::guard('web')->user()->about != null)
                                                        <ul class="details-list column-count-one">
                                                            <li class="lists">
                                                                ...
                                                                <span class="list-strong">
                                                                    {{ Auth::guard('web')->user()->about }} </span>
                                        ...
                                        <div class="media-upload-btn-wrapper">
                                            <div class="img-wrap">
                                                {!! render_gallery_image_attachment_preview(Auth::guard('web')->user()->profile_gallery ?? '') !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
