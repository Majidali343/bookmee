...
<?php endif; ?>
                                    ...
                                    <div class="profile-info-dashboard margin-top-40">
                                        <div class="profile-btn-flex">
                                            ...
                                            <div class="btn-wrapper">
                                                <a href="<?php echo e(route('buyer.profile.edit')); ?>" class="cmn-btn btn-bg-1"> <?php echo e(__('Edit Profile')); ?> </a>
                                            </div>
                                        </div>
    ...
    <!-- Dashboard area end -->
    <?php $__env->stopSection(); ?>  
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/dazzling-edison.217-174-244-122.plesk.page/httpdocs/@core/resources/views/frontend/user/buyer/profile/buyer-profile.blade.php ENDPATH**/ ?>