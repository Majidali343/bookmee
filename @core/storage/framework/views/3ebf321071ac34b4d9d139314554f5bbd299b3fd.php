<script>
    ...
    <script src="<?php echo e(asset('./@core/public/js/app.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\Bookmee\@core\resources\views/components/livechat/widget-js.blade.php ENDPATH**/ ?>