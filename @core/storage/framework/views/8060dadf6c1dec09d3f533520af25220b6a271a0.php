...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                    <form action="<?php echo e(route('seller.edit.service.attribute.offline.to.online',$get_service->id)); ?>" method="post">
                        <?php echo csrf_field(); ?>

                        <input type="hidden" name="service_id" value="<?php echo e($get_service->id); ?> ">
                        <?php if($get_service->is_service_online == 0): ?>
                            <input type="hidden" name="is_service_online_id" value="1"  id="is_service_online_id">
                        <?php else: ?>
                            <input type="hidden" name="is_service_online_id" value="0"  id="is_service_online_id">
                        <?php endif; ?>
                            ...
                            <div class="col-xl-8 margin-top-50">
                                <?php if($get_service->is_service_online == 1): ?>
                                    <div class="dashboard-switch-single margin-bottom-30">
                                        <input class="custom-switch is_service_online" id="is_service_online" type="checkbox" disabled/>  <?php echo e(__('Online To Offline Service')); ?>

                                        <label class="switch-label" for="is_service_online"></label>
                                    </div>
                                <?php else: ?>
                                    <div class="dashboard-switch-single margin-bottom-30">
                                        <input class="custom-switch is_service_online" id="is_service_online" type="checkbox" checked disabled/> <?php echo e(__('Offline To Online Service')); ?>
                                ...
                                <div class="single-settings">
                                    ...
                                    <div class="append-additional-includes">
                                        <div class="single-dashboard-input what-include-element">
                                            ...
                                            <?php if($get_service->is_service_online == 1): ?>
                                                <div class="single-info-input margin-top-20 <?php if($get_service->is_service_online == 0): ?> is_service_online_hide <?php endif; ?>">
                                    ...
                                    <?php if($get_service->is_service_online == 0): ?>
                                        <!-- for offline to online service section start -->
                                        <div class="single-settings for_offline_service_default_hide">
                                        ...
                                        <!-- for offline to online service section end -->
                                    <?php endif; ?>
    ...
    <script>
        (function ($) {
            ...
            $(document).ready(function() {
                ...
                $(".add-what-includes").on('click',function(){
                    ...
                    if(total_element < max ){
                        $(".append-additional-includes").append(
                          ...
                          <?php if($get_service->is_service_online == 1): ?>  <div class="single-info-input margin-top-20 <?php if($get_service->is_service_online == 0): ?> is_service_online_hide <?php endif; ?>">\
                                <label><?php echo e(__('Unit Price')); ?></label>\
                                <input class="form--control include-price" type="number" step="0.01" name="include_service_price[]" placeholder="<?php echo e(__('Add Price')); ?>">\
                            </div>\
                            <div class="single-info-input margin-top-20 <?php if($get_service->is_service_online == 0): ?> is_service_online_hide <?php endif; ?>">\
                            ...
                            </div><?php endif; ?><span class="btn btn-danger remove-include"><i class="las la-times"></i></span>\
                                </div>'
                        );
                    }
                ...
                //total price
                $(document).on("change", ".include-price-online-price", function() {
                    var sum = 0;
                    $(".include-price-online-price").each(function() {
                        if(isNaN($(this).val())){
                    ...
                    $("#service_total_price_offline").val(sum);
                });
            })
        })(jQuery)
    </script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/dazzling-edison.217-174-244-122.plesk.page/httpdocs/@core/resources/views/frontend/user/seller/services/add-service-attributes-offline-to-online-by-id.blade.php ENDPATH**/ ?>