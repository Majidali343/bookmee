                    ...
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <div class="left-content">
                                <h4 class="header-title"><?php echo e(__('Email Notify')); ?>  </h4>
                                ...
                                <form action="#" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group  mt-3">
                                        <label for="site_logo"><?php echo e(__('Select how many days earlier expiration mail alert will be send')); ?></label>
                                        <br>
                                        <select name="package_expire_notify_mail_days[]" class="form-control expiration_dates" multiple="multiple" data-placeholder="<?php echo e(__('Select Days')); ?>">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/dazzling-edison.217-174-244-122.plesk.page/httpdocs/@core/Modules/Subscription/Resources/views/backend/settings.blade.php ENDPATH**/ ?>