                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="dashboard-settings margin-top-40">
                                <h2 class="dashboards-title"> <?php echo e(__('Report Details')); ?> </h2>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="gig-chat-message-heading">
                                        ...
                                        <div class="gig-order-info">
                                            ...
                                            <p><strong><?php echo e(__('Report From:')); ?></strong> <?php echo e(ucfirst($report_details->report_from)); ?></p>
                                        </div>
...
<?php endif; ?>
                                            ...
                                            <form action="<?php echo e(route('buyer.order.report.chat.admin',$report_details->id)); ?>" method="post" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/dazzling-edison.217-174-244-122.plesk.page/httpdocs/@core/resources/views/frontend/user/buyer/report/report-chat.blade.php ENDPATH**/ ?>