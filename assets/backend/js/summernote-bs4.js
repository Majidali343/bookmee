    ...
    var ImageDialog = /** @class */ (function () {
        ...
        ImageDialog.prototype.initialize = function () {
            ...
            var body = [
                ...
                '<input type="hidden" name="summer_note_image" value="">',
        ...
        ImageDialog.prototype.showImageDialog = function () {
            ...
            return $$1.Deferred(function (deferred) {
                ...
                var $imageUploader = _this.$dialog.find('.media_upload_form_btn');
                ...
                _this.ui.onDialogShown(_this.$dialog, function () {
                    ...
                    $imageUploader.on('click', function () {
                        ...
                        //todo work on change upload image url
                        uploadedImageUrl = $imageUploader.prev('input').data('imgsrc');
                    });
                    if (!env.isSupportTouch) {
                    ...
                    $imageBtn.click(function (event) {
                        event.preventDefault();
                        //todo work on change upload image url
                          var uploadedImageUrl = $(this).parent().parent().find('input[name="summer_note_image"]').data('imgsrc');
                         
                            uploadedImageUrl = uploadedImageUrl.replace('grid-','');
                        if (uploadedImageUrl != ''){
                            let imageUrlReplaced = $imageUploader.prev('input').attr('data-imgsrc');
                            imageUrlReplaced = imageUrlReplaced.replace('grid-','');

                            deferred.resolve(imageUrlReplaced);
                            $imageUploader.parent().find('.img-wrap').html('');
                            $imageUploader.prev('input').removeAttr('data-imgsrc');
                            $imageUploader.prev('input').val();
                            $imageUploader.text('Upload Image');
                        }
                    });
